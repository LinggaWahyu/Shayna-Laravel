                                    ...
                                    @forelse ($items as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @endif
                                                {{-- <a href="#mymodal" data-remote="{{ route('transactions.show', $item->id) }}" data-toogle="modal" data-target="#mymodal" data-title="Detail Transaksi {{ $item->uuid }}" class="btn btn-info btn-sm">
                                                    <i class="fa fa-eye"></i>
                                                </a> --}}
